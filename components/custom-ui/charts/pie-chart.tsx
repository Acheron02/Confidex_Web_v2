    ...
    <Card data-chart={id} className="flex flex-col h-full">
      ...
      <CardHeader className="flex-row items-start space-y-0 pb-0">
        ...
        <Select value={activeMonth} onValueChange={setActiveMonth}>
          <SelectTrigger
            className="ml-auto h-7 w-[130px] rounded-lg pl-2.5 hover:cursor-pointer"
          ...
          >
            {months.map((key) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 text-xs hover:cursor-pointer">
                    <span
      ...
      {/* Chart content */}
      <CardContent className="flex justify-center w-full max-h-[70vh] overflow-y-auto pb-0">
        <ChartContainer
          id={id}
          config={chartConfig}
